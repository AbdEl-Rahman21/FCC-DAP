...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_percentages = df.loc[df['salary'] == '>50K', 'native-country'].value_counts() / df['native-country'].value_counts()
    highest_earning_country = highest_earning_percentages.idxmax()
    highest_earning_country_percentage = round(highest_earning_percentages.max() * 100, 1)
